...
createCSSRule('.enter-AR-button', "position: absolute; display: block; z-index: 1; background-color: rgba(255,255,255, 0); width: 200px; height: 50px; bottom: 20px; left: 50%; background-size: 100%; margin-left: -100px; cursor: pointer; outline: 0;", false, '');
...
createCSSRule('.warning-AR-unavialable', "position: absolute; width: 242px; height: 50px; left: 50%; margin-left: -121px; display: none;", false, '');
addHTMLElement('div', 'warning_AR_unavailable', 'TO', 'warning_center', false);
setHTMLElemAttribute('className', 'warning-AR-unavialable', 'warning_AR_unavailable', false);
...
setHTMLElemAttribute('href', 'media/info.png', 'info_button', false);
...
operateAnimation('PLAY', 'janvi_armature', 0, 100, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/Game-over.mp3'), 0.5);
registerOnClick('janvi_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'janvi_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/Game-over.mp3'), false);

  operateAnimation('PLAY', 'janvi_armature', 100, 176, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'janvi_group'], false);
      ...
      changeVis(['GROUP', 'janvi_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('janvi_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('janvi_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('janvi_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'janvi.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'janvi_group'], true);
  setObjTransform('janvi_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('janvi_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('janvi_armature', 'XY', 'WORLD', '[Z!hH}-7PnB,ahtRq!Jn', 'imk:Xnr#fNjFxEqGpYr}');
}, function() {}, 'imk:Xnr#fNjFxEqGpYr}');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('janvi_armature', 'Z', 'WORLD', 'rPa~b@!6VGTEwZMT:~.a', 'x{v;kboNMGa|fhI9OM,k');
}, function() {}, 'x{v;kboNMGa|fhI9OM,k');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('janvi_armature', 'Z', 'GH7mLa}X]f@]~8{N6cUt', 'AumU?4$jRHMdA7W!rxeo');
  dragScale('janvi_armature', 'X', ']MXECsTjkMQB*Fl}N4fp', 'AumU?4$jRHMdA7W!rxeo');
  dragScale('janvi_armature', 'Y', '1ddS75FmYCqp{O6z^tub', 'AumU?4$jRHMdA7W!rxeo');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('janvi_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'AumU?4$jRHMdA7W!rxeo');
